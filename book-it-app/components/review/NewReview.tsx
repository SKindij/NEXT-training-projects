// @path: @/components/review/NewReview.tsx
import React from "react";

// компонент відображення форми для подання нового відгуку
const NewReview = () => {
  return (
    <>
      {/* відкриває модальне вікно для відгуку */}
      <button type="button"
      ...
      >
        <div className="modal-dialog" role="document">
          <div className="modal-content">
            ...
            {/* тіло модального вікна з текстом відгуку */}
            ...
            {/* кнопка для підтвердження відгуку */}
